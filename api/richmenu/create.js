...
export default function (req, res) {
  ...
  } else if (req.body.action === "create_alias") {
    fetch("https://api.line.me/v2/bot/richmenu/alias", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${req.body.accessToken}`,
        "Content-Type": "application/json"
      ...
      body: JSON.stringify({
        richMenuId: req.body.richMenuId,
        richMenuAliasId: req.body.richMenuAliasId
      })
    })
      .then((response) => {
        if (response.status !== 200) {
